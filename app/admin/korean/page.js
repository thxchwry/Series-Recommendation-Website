...
import AdminCardKorean from '@/components/AdminCardKorean';
...
export default function ChineseSeriesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch('http://localhost:3000/api/attractions/korean');
  ...
  return (
    ...
    <Breadcrumbs>
        ...
        <Typography color="textPrimary">Korean Series</Typography>
      </Breadcrumbs><br></br>
      <Typography variant="h4" gutterBottom>Korean Series</Typography>

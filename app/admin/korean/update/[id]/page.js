...
export default function UpdateKoreanPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await fetch(`http://localhost:3000/api/insert/korean/${id}`)
    ...
    return (
        <Box maxWidth={600} mx="auto" mt={5}>
            <Typography variant="h5" mb={2}><center><h2>Edit Korean Series</h2></center> </Typography>

...
export default function Page() {
    ...
    // ดีบักค่า formData หลังจากการอัปเดต
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`http://localhost:3000/api/insert/korean`, {
                method: 'POST',
                headers: {
            ...
            // เช็กว่าค่าที่ได้มาเป็น JSON ได้จริงหรือเปล่า
    ...
    return (
        <Box maxWidth={600} mx="auto" mt={5}>
            <Typography variant="h5" mb={2}><center><h2>Create New Korean Series</h2></center></Typography>

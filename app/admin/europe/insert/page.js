...
import {TextField,Button,Typography,Box,Stack
} from '@mui/material'
...
export default function Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`http://localhost:3000/api/insert/europe`, {
                method: 'POST',
                headers: {
    ...
    return (
        <Box maxWidth={600} mx="auto" mt={5}>
            <Typography variant="h5" mb={2}><center><h2>Create New TV Series</h2></center></Typography>
